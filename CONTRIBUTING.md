# Contribute to nextjs-mongoose-app

:+1::tada: Thank you for being here. It is people like you that make `nextjs-mongoose-app` great and help shape a better open-source community.
...
## What `nextjs-mongoose-app` is looking for
...
`nextjs-mongoose-app` follows [Airbnb JavaScript Style Guide](https://github.com/airbnb/javascript). Please run `npm run lint` and fix any linting warnings.
